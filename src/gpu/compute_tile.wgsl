...
fn fs_main(in: VertexOutput) -> [[location(0)]] vec4<f32> {
    ...
    var a: f32 = (1.0 - ((t0*t0) / (1024.0*1024.0)));
    a = max(min(a, 1.0), 0.0);
    let t = t0 * 0.005;
    var r: f32 = a * sin((0.5 - t) * pi_3 * 3.0 + pi_3 * 0.0);
    var g: f32 = a * sin((0.5 - t) * pi_3 * 3.0 + pi_3 * 1.0);
    var b: f32 = a * sin((0.5 - t) * pi_3 * 3.0 + pi_3 * 2.0);
